...
## 學習軌跡
這是我的學習內容，按照架構，可以分層介紹：  
### 底層電子元件知識 -> 積體電路設計架構 -> 演算法  

### 底層電子元件課程  
電子學 (一) A , 電路學 A , 電子實驗(一)/(二) A/A , 類比積體電路導論 A-  
### 積體電路設計架構  
數位實驗 A-, 超大型積體電路設計導論 A+, 數位電路與設計 A+, (研)進階可程式邏輯系統設計與應用 A+  
### 演算法  
離散數學 A, 線性代數 A+, 演算法導論 B+, 無線網路導論 A, 人工智慧導論(尚未公布), (研)影像處理(尚未公布) 
### 輔助資料處理  
